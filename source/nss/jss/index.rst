...
:ref:`Mozilla_Projects_NSS_reference`. JSS also provides a pure Java
...
`NSPR <https://developer.mozilla.org/en-US/docs/NSPR>`__ and
...
|                                   |                                   |
| Cryptography <https://developer.m | -                                 |
| ozilla.org/en-US/docs/Introductio |   `Security <https://developer.mo |
| n_to_Public-Key_Cryptography>`__. | zilla.org/en-US/docs/Security>`__ |
...
|                                   |                                   |
| -                                 |                                   |
|   :ref:`Mozilla_Projects_NSS_JSS_ |                                   |
| Build_instructions_for_JSS_4_4_x# |                                   |
| build_instructions_for_jss_4_4_x` |                                   |
| -  `Building JSS                  |                                   |
|    4.3.x <https://develop         |                                   |
| er.mozilla.org/en-US/docs/JSS/Bui |                                   |
