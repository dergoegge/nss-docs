...
Network Security Services (NSS) 3.19.2.4 is a security patch release for NSS 3.19.2. The bug fixed
in NSS 3.19.2.4 have been described in the "Security Fixes" section below.

(Current users of NSS 3.19.3, NSS 3.19.4 or NSS 3.20.x are advised to update to `NSS
3.21.1 </en-US/docs/Mozilla/Projects/NSS/NSS_3.21.1_release_notes>`__, `NSS
3.22.2 </en-US/docs/Mozilla/Projects/NSS/NSS_3.22.2_release_notes>`__ or a later release.)
...
without recompiling or relinking. Furthermore, applications that restrict the use of NSS APIs to the
