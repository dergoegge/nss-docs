...
-  The following **1024-bit** root CA certificate was **restored** to
   ...
   sites. It was removed in
   :ref:`Mozilla_Projects_NSS_NSS_3_16_3_release_notes`, but discussion
   in the mozilla.dev.security.policy forum led to the decision to keep
   this root included longer in order to give website administrators
   more time to update their web servers.
...
-  In :ref:`Mozilla_Projects_NSS_NSS_3_16_3_release_notes`, the
   **1024-bit** "Entrust.net Secure Server Certification Authority" root
   CA certificate (SHA1 Fingerprint:
