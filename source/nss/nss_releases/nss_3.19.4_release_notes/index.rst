...
Network Security Services (NSS) 3.19.4 is a patch release for NSS 3.19. The bug fixes in NSS 3.19.4
...
NSS 3.19.4 and NSPR 4.10.10 source distributions are available on ftp.mozilla.org for secure HTTPS
download:
