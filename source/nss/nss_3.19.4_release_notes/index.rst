...
Network Security Services (NSS) 3.19.4 is a patch release for NSS 3.19.
The bug fixes in NSS 3.19.4 are described in the "Security Advisories"
section below.
...
NSS 3.19.4 and NSPR 4.10.10 source distributions are available on
...
NSS 3.19.4 shared libraries are backward compatible with all older NSS
3.x shared libraries. A program linked with older NSS 3.x shared
libraries will work with NSS 3.19.4 shared libraries without recompiling
