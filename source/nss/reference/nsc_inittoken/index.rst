...
Specifically, ``NSC_InitToken()`` initializes or clears the key database, removes the password, and
...
-  ``CKR_TOKEN_WRITE_PROTECTED``
   ...
   -  slot ID is 1. (The non-FIPS mode has two slots: 1 and 2. The key database is in slot 2. Slot 1
      doesn't have a key database.)
...
-  `NSC_InitPIN </en-US/NSC_InitPIN>`__, `FC_InitToken </en-US/FC_InitToken>`__