...
``pInfo``
   points to a
   `CK_TOKEN_INFO <https://developer.mozilla.org/en-US/CK_TOKEN_INFO>`__
   structure
...
-  `FC_GetSlotInfo <https://developer.mozilla.org/en-US/FC_GetSlotInfo>`__,
   `NSC_GetTokenInfo <https://developer.mozilla.org/en-US/NSC_GetTokenInfo>`__