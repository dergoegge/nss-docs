...
Previously, with rare server configurations, an MD5 signature algorithm might have been selected for
client authentication and caused the client to abort the connection soon after.
...
-  The following bug has been fixed in NSS 3.25.1: `Ignore MD5 signature algorithms in certificate
